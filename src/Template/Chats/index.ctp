...
$currentuser = $this->request->session()->read('Auth.User');
  ...
  foreach ($chats as $chat):
    ...
    echo $this->Html->link($chat->product->name.$this->Html->image('Users/'.$chat->user_id, array('alt' => 'Buyer', 'class' => 'userimgchats', 'escape' => false)), array('controller' => 'Chats', 'action' => 'view', $chat->id), array('class' => 'chatlink2', 'escape' => false));
  }
  endforeach;
?>
